    ...
    public static partial class Unidecoder
    {
        ...
        public static string Unidecode(this string input, int? tempStringBuilderCapacity = null)
        {
            ...
            foreach (var c in input)
                ...
                else
                {
                    ...
                    if (Characters.TryGetValue(high, out transliterations)) sb.Append(transliterations[low]);
                }
        ...
        public static string Unidecode(this char c)
        {
            ...
            else
            {
                ...
                var low = c & 0xff;
                string[] transliterations;
                result = Characters.TryGetValue(high, out transliterations) ? transliterations[low] : string.Empty;
            }
